...
!(function (t) {
    function i(i) {
        ...
        isEmpty(n) && (n = 500),
            t(e).animate(
                ...
                function () {
                    isEmpty(s) &&
                        (t(e).css('display', 'none'), t(e).css('height', ''));
                },
            );
    }
    function a(i) {
        ...
        var o = t(i).attr('data-time');
        isEmpty(o) && (o = 500),
            isEmpty(s) ||
                (t(e).css('height', s + 'px'), t(e).addClass('no-gradient')),
            t(e).animate({ height: l }, parseInt(o, 10));
    }
    t(document).ready(function () {
        t('body').on('click', '.tab-box .nav li', function (i) {
            ...
            if (
                (t.isFunction(t.fn.initIsotope) &&
                    t(n)
                        .find('.maso-list')
                        .each(function () {
                            t(this).initIsotope();
                        }),
                t(this).closest('.mega-menu').length)
            )
                return !1;
            i.preventDefault();
        }),
            ...
            t('*[data-height].collapse-box').each(function () {
                ...
                t(i).css('height', t(this).attr('data-height') + 'px'),
                    t(i).show();
            }),
        ...
        t('.collapse-box .collapse-button').toggleClick(
            function () {
                var i = this;
                a(i);
                var e = t(i).attr('data-button-open-text boxed-inverse');
                isEmpty(e) ||
                    (t(i).attr(
                        'data-button-close-text boxed-inverse',
                        t(this).find('b').html(),
                    ),
                    setTimeout(function () {
                        t(i).find('b').html(e);
            ...
            function () {
                var a = this;
                i(a);
                var e = t(a).attr('data-button-close-text boxed-inverse');
                isEmpty(e) ||
                    setTimeout(function () {
                        t(a).find('b').html(e);
                    }, 500);
        ...
        t('body').on(
            ...
            function () {
                ...
                if (
                    ...
                    var o = t(a).find('.panel');
                    isEmpty(s) && (s = 500),
                        t(o).animate({ height: 0 }, s, function () {
                            t(o).css('display', 'none').css('height', '');
                        });
                } else {
                    var h = 0,
                        c = t(i).find('.list-group-item > a');
                    t(c).each(function () {
                        t(this).hasClass('active') && (h = 300);
                    }),
                        t(c).removeClass('active'),
                        t(this).addClass('active'),
                        t(a).addClass('active-panel'),
                        'visible' == e
                            ? t(t(a).find('.panel')).collapse({
                                  milliseconds: s,
                                  height: n,
                              })
                            : (t(l).animate({ height: 0 }, h, function () {
                                  t(l).css('display', 'none').css('height', '');
                              }),
                              'accordion' == e
                                  ? t(a).find('.panel').collapse({
                                        milliseconds: s,
                                        height: n,
                                    })
                                  : t(l)
